...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #32b18e; position: relative; width:1920px;">
        <a class="navbar-brand" href="ManagerScreen.php"><?php
                                                            echo $userName; ?></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" style="color:white">>Pay</a>
                </li>
    ...
    if (isset($_POST['changeD']) == 'changeThisMonthDue') {
        ...
        $sql = "SELECT * FROM normal WHERE username='$userName'";
        ...
        if ($sqlForPerson->num_rows > 0) {
            while ($row = $sqlForPerson->fetch_row()) {
                ...
                if (($personDue - $due) >= 0) {
                    ...
                    $sqlDue = "UPDATE normal SET due='$newDue' WHERE username='$userName'";
                    ...
                    echo '<script>Swal.fire("Error", "Dues cannot be negative", "error"); </script>';
            }
        }
    }
    $conn->close();
