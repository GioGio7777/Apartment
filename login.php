...
<body>
    ...
    <div class="loginDiv">
        ...
        <form id="login" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            ...
            <div class="form-group" id="pwForm">
                ...
                <br>
                <input type="checkbox" onclick="rememberMe()" id="rememberMe" name="rememberMe"> Remember Me
            </div>

            <button type="submit" id="btn" class="btn btn-primary" onclick="progress()">Submit</button>
    ...
    if (!empty($name) && !empty($pwd)) {
        ...
        if ($resultManager->num_rows > 0) {
            ...
            echo '<script>Swal.fire("Welcome $name", "Login Successful", "success"); </script>';
